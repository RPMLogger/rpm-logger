...
function initMailCenterTab() {
  ...
  if (section.dataset.built !== "1") {
    section.innerHTML =
      '<button id="gBusinessBtn" onclick="_openGBusinessGmail()" style="display:flex;align-items:center;justify-content:space-between;width:100%;padding:14px 16px;background:var(--panel);border:1px solid var(--border);border-radius:6px;cursor:pointer;color:var(--text);font-size:13px;font-family:inherit">' +
